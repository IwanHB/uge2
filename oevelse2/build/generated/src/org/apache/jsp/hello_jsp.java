...
public final class hello_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    <body>      \n");
      out.write("        \n");
      out.write("        <div id=\"navneboksen\">\n");
      out.write("            ");
      out.print(request.getParameter("firstname"));
      out.write("\n");
      out.write("        </div>\n");
      out.write("        <h1>Tabel med data fra formularen:</h1>\n");
      out.write("        <div id=\"tableDiv\">\n");
      out.write("        <table>\n");
      out.write("            <tr>\n");
      out.write("            <td>Fornavn:</td><td>");
      out.print(request.getParameter("firstname"));
      out.write("</td>\n");
      out.write("            </tr>            \n");
      out.write("            <tr>\n");
      out.write("            <td>Efternavn:</td><td>");
      out.print(request.getParameter("lastname"));
      out.write("</td>\n");
      out.write("            </tr>        \n");
      out.write("            <tr>\n");
      out.write("            <td>By:</td><td>");
      ...
      out.write("            </tr>        \n");
      out.write("            <tr>\n");
      out.write("            <td>Mobilnummer:</td><td>");
      out.print(request.getParameter("phone"));
      out.write("</td>\n");
      out.write("            </tr>       \n");
      out.write("            <tr>\n");
      out.write("            <td>Fødselsår:</td><td>");
      out.print(request.getParameter("year"));
      out.write("</td>\n");
      out.write("            </tr>        \n");
      out.write("            <tr>\n");
      out.write("            <td>Køn:</td><td>");
      out.print(request.getParameter("sex"));
      out.write("</td>\n");
      out.write("            </tr>        \n");
      out.write("            <tr>\n");
      out.write("            <td>Beskrivelse:</td><td>");
      out.print(request.getParameter("description"));
      out.write("</td>\n");
      out.write("            </tr>\n");
      out.write("            <tr>\n");
      out.write("            <td>Billede:</td><td><img src=\"\"></td>\n");
      out.write("            </tr>\n");
      out.write("            </div>\n");
      out.write("    </body>\n");
      out.write("</html>\n");
